...
void camera_sensor_address_swap(struct msm_sensor_ctrl_t *s_ctrl)
{
	...
	s_ctrl->sensordata->slave_info->sensor_slave_addr
		= s_ctrl->sensordata->slave_info->sensor_backup_slave_addr;

	s_ctrl->sensordata->slave_info->sensor_backup_slave_addr = temp;
 ...
 */
			...
			continue;
#else
			if (s_ctrl->sensordata->slave_info->sensor_backup_slave_addr) {
