...
/*
  ...
  */
// --->
	      slave_info->backup_slave_addr = slave_info32->backup_slave_addr;
// <---400006
 ...
 * by ZTE_YCM_20140909 yi.changming 400006
 */
	camera_info->sensor_backup_slave_addr = slave_info->backup_slave_addr;
// <---400006
